    ...
    sections: [
      {
        id: 's1', type: 'reading_list',
        label: '問題1',
        instruction: '次の会話を読んで、下線部①〜⑧の読みをひらがなで書きなさい。',
        contextLines: [
          '多田：週末に、千葉県にある手賀①沼に遊びに行ってきたんだ。',
          '赤川：手賀沼って、一時期、水が汚くて、水質の②汚濁が日本で一番ひどいと',
          '　　　言われていた沼でしょう？',
          '多田：1974年から2001年まで27年連続ワースト1位っていう③不名誉な記録があるんだけど、',
          '　　　1998年から我孫子市が④浄化事業に取り組むようになって、少しずつよくなったんだ。',
          '赤川：汚くなった原因は何？',
          '多田：1950年代まではウナギなんかの⑤漁獲が多い、きれいな沼だったらしいんだけど、',
          '　　　その後、周りが都市化して、⑥急激に人口が増えて、それに⑦伴って、',
          '　　　生活や産業による⑧排水が流れ込むようになったんだ。',
        ],
        questions: [
          { num: 1, target: '沼',       answer: 'ぬま' },
          { num: 2, target: '汚濁',     answer: 'おだく' },
          { num: 3, target: '不名誉',   answer: 'ふめいよ' },
          { num: 4, target: '浄化事業', answer: 'じょうかじぎょう' },
          { num: 5, target: '漁獲',     answer: 'ぎょかく' },
          { num: 6, target: '急激',     answer: 'きゅうげき' },
          { num: 7, target: '伴って',   answer: 'ともなって' },
      ...
      },
      {
        ...
        sentences: [
          ...
          { num: 11, full: '近隣に住む人々と交流する。',
            targets: [{ word: '近隣', answer: 'きんりん' }] },
          { num: 12, full: '山頂まで緩やかな傾斜が続いている。',
            targets: [{ word: '緩やか', answer: 'ゆるやか' }, { word: '傾斜', answer: 'けいしゃ' }] },
          { num: 13, full: '溝に大量の水が流れ込んだ。',
            targets: [{ word: '溝', answer: 'みぞ' }] },
          { num: 14, full: '点滴で痛み止めを入れる。',
            targets: [{ word: '点滴', answer: 'てんてき' }] },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        instruction: '次の会話を読んで、下線部①〜⑫の読みをひらがなで書きなさい。',
        contextLines: [
          '先生：今日はミツバチの生態について勉強しましょう。ミツバチについて何か知っていますか。',
          '学生1：花から①蜜を集めて、はちみつを作ることぐらいかな。はちみつが好きで、よく買います。',
          '先生：ミツバチは②昆虫で、群れを作って生活をしています。群れは、女王バチ（1③匹）、',
          '　　　④雌の働きバチ、⑤雄のハチで構成されています。女王バチは、雄のハチと⑥交尾して、',
          '　　　産卵します。働きバチは⑦巣を造ったり、⑧餌を採ったりします。',
          '学生2：分業ができているんですね。',
          '先生：そうですね。この分業をうまく行うために、女王バチは⑨揮発性の化学物質を出します。',
          '　　　例えば、雄を⑩誘引する性フェロモンや、働きバチの卵の発育を⑪抑制する',
          '　　　階級⑫維持フェロモンです。',
          '学生2：卵を女王バチが産めるようにするためですか。',
          '先生：そうです。',
          'A：働きバチも外敵にあったとき、警報フェロモンといわれる物質を出します。',
          '　　ある働きバチを興奮させると、針を突き出し、臭気を出してほかの働きバチも',
          '　　興奮させて、攻撃するようにします。',
        ],
        questions: [
          { num: 1,  target: '蜜',     answer: 'みつ' },
          { num: 2,  target: '昆虫',   answer: 'こんちゅう' },
          { num: 3,  target: '匹',     answer: 'ひき' },
          { num: 4,  target: '雌',     answer: 'めす' },
          { num: 5,  target: '雄',     answer: 'おす' },
          { num: 6,  target: '交尾',   answer: 'こうび' },
          { num: 7,  target: '巣',     answer: 'す' },
          { num: 8,  target: '餌',     answer: 'えさ' },
          { num: 9,  target: '揮発性', answer: 'きはつせい' },
          { num: 10, target: '誘引',   answer: 'ゆういん' },
          { num: 11, target: '抑制',   answer: 'よくせい' },
          { num: 12, target: '維持',   answer: 'いじ' },
        ],
      },
      {
        id: 's2', type: 'reading_sentences',
        ...
        sentences: [
          ...
          { num: 4,  full: '割れた貝殻が入っていたので、袋がさけてしまった。',
          ...
          { num: 7,  full: 'てきからの攻撃が止まり、安堵した。',
            writingTargets: [{ word: 'てき', answer: '敵' }] },
          { num: 8,  full: 'たつまきで家の屋根が飛ばされてしまった。',
            writingTargets: [{ word: 'たつまき', answer: '竜巻' }] },
          { num: 9,  full: '冬眠する動物は夏の終わりから秋にかけて体に脂肪をたくわえ、生命を維持する。',
            writingTargets: [{ word: 'たくわえ', answer: '蓄え' }] },
          { num: 10, full: '彼女は10年に一人の逸材だと言われる。',
            targets: [{ word: '逸材', answer: 'いつざい' }] },
